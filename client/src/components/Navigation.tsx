      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link href="/" className="hover:text-[#F4A460] transition-colors font-medium">Home</Link>
            <Link href="/gallery" className="hover:text-[#F4A460] transition-colors font-medium">Gallery</Link>
        ...
        {isOpen && (
          <div className="md:hidden pb-4 space-y-2 border-t border-[#2D5016]">
            <Link href="/" className="block px-4 py-2 rounded-lg hover:bg-[#2D5016] transition-colors">Home</Link>
            <Link href="/gallery" className="block px-4 py-2 rounded-lg hover:bg-[#2D5016] transition-colors">Gallery</Link>
